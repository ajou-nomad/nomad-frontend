    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.reviewContainer} >
                ...
                <Image source={{ uri: item.reviewList[0].imgUrl }} resizeMode='contain' style={{ width: responsiveWidth(65), height: responsiveHeight(40) }}/>
                <Text style={{ ...FONTS2.body2, marginTop: 15, }}>{item.reviewList[0].contents}</Text>

                <View style={styles.menu}>
                    <Text style={{ ...FONTS2.body2, color: COLORS.darkgray, marginTop: 20, }}>주문 메뉴</Text>
                    <FlatList data={orderItemList} keyExtractor={item => item.menuId} renderItem={renderItem}/>
                </View>
            </View>
        </View>
    );
